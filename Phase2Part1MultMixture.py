...
for iteration in range(10):#number of execution
    print iteration
    print '=========================='
   #E_Step:
...
#evaluation: 
microMeasure = f1_score(myY, predictY, average='micro')  
macroMeasure = f1_score(myY, predictY, average='macro') 
adjustedRIMeaasure = adjusted_rand_score(myY, predictY)